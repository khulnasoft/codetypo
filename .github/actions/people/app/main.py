...
query Q($after: String, $category_id: ID) {
  repository(name: "codetypo", owner: "khulnasoft") {
...
if __name__ == "__main__":
    ...
    maintainers_logins = {"khulnasoft-bot"}
    ...
    if (
        ...
        logging.info("The KhulnaSoft People data hasn't changed, finishing.")
        sys.exit(0)
    ...
    message = "👥 Update KhulnaSoft People"
