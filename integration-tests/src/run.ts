    ...
    program
        ...
        .description(
            'Add a repository to be checked.\n' +
                '  Example: add "https://github.com/khulnasoft/codetypo.git".\n' +
...
const cmd = createCommand('tester').description(`Validate CodeTypo results against various GitHub repositories.
