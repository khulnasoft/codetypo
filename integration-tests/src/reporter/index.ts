...
import type { CodeTypoReporter, Issue, ReporterConfiguration, RunResult } from '@codetypo/codetypo-types';
...
export function getReporter(_settings: unknown, config?: Config): CodeTypoReporter {
    ...
    const reporter: CodeTypoReporter = {
        issue: (issue) => {
...
export function getReporterListAll(_settings: unknown, config?: Config): CodeTypoReporter {
