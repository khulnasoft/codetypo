...
*For non-critical additions, please see our [monthly pinned issue](https://github.com/khulnasoft/codetypo/issues).*

*For false positives, please [open an issue](https://github.com/khulnasoft/codetypo/issues) first to see if we have agreement.*

`codetypo` dictionary is a mapping of codetypo to a list of possible corrections (see [Design](docs/design.md)).

If you aren't in a hurry, [we have a pinned
Issue](https://github.com/khulnasoft/codetypo/issues) to collect dictionary changes
to be done in bulk in an attempt to lower the barrier for improving the dictionary.

Otherwise, to add to the dictionary:

1. Add your typo to our data file `crates/codetypo-dict/assets/words.csv`
...
- Mixing up corrections and codetypo
- etc
...
- `clippy`
- `rustdoc`
- [`committed`](https://github.com/khulnasoft/committed) as we use [Conventional](https://www.conventionalcommits.org) commit style
- [`codetypo`](https://github.com/khulnasoft/codetypo) to check spelling
...
[issues]: https://github.com/khulnasoft/codetypo/issues
[new issue]: https://github.com/khulnasoft/codetypo/issues/new
[all issues]: https://github.com/khulnasoft/codetypo/issues?utf8=%E2%9C%93&q=is%3Aissue
[CI]: https://github.com/khulnasoft/codetypo/tree/master/.github/workflows
