...
import type { CodeTypoReporter } from '@codetypo/codetypo-types';
import type { CodeTypoApplicationOptions, Issue, ProgressItem, RunResult } from 'codetypo';
import { checkText, lint, trace } from 'codetypo';
...
class ConsoleLogger implements CodeTypoReporter {
    log: string[] = [];
    issueCount = 0;
    errorCount = 0;
    debugCount = 0;
