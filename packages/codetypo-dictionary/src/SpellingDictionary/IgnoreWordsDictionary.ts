import { opFilter, opMap, pipe } from '@codetypo/codetypo-pipe/sync';
import type { CompoundWordsMethod, SuggestionResult } from 'codetypo-trie-lib';
import { parseDictionaryLines } from 'codetypo-trie-lib';
