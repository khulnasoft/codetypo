import type { DictionaryInformation, ReplaceMap } from '@codetypo/codetypo-types';
import type { SuggestionCollector, SuggestionResult, WeightMap } from 'codetypo-trie-lib';

import type { SuggestOptions } from './SuggestOptions.js';

export type { DictionaryDefinitionInline } from '@codetypo/codetypo-types';
