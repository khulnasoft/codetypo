...
describe('url', () => {
    ...
    test.each`
        ...
        ${'https://github.com/khulnasoft/codetypo/README.md'}          | ${undefined}                                 | ${'https://github.com/khulnasoft/codetypo/README.md'}
        ${'README.md'}                                                 | ${'https://github.com/khulnasoft/codetypo/'} | ${'https://github.com/khulnasoft/codetypo/README.md'}
        ${new URL('https://github.com/khulnasoft/codetypo/README.md')} | ${undefined}                                 | ${'https://github.com/khulnasoft/codetypo/README.md'}
        ${'vsls:/codetypo.config.yaml'}                                | ${undefined}                                 | ${'vsls:/codetypo.config.yaml'}
        ${'stdin:sample.py'}                                           | ${'file:///'}                                | ${'stdin:sample.py'}
        ${'vsls:/codetypo.config.yaml'}                                | ${'file:///'}                                | ${'vsls:/codetypo.config.yaml'}
    ...
    test.each`
        ...
        ${'https://github.com/khulnasoft/codetypo/raw/main/packages/codetypo-io/samples/code/'}         | ${'code/'}
    ...
    test.each`
        ...
        ${'https://github.com/khulnasoft/samples/cities.txt'} | ${'https://github.com/khulnasoft/samples/'}
        ${'stdin:/github.com/khulnasoft/samples/'}            | ${'stdin:/github.com/khulnasoft/'}
        ${'stdin:github.com/khulnasoft/samples/'}             | ${'stdin:github.com/khulnasoft/'}
        ${'vsls:/codetypo.config.yaml'}                       | ${'vsls:/'}
    ...
    test.each`
        ...
        ${'https://github.com/khulnasoft/samples/cities.txt'} | ${true}
    ...
    test.each`
        ...
        ${'https://github.com/khulnasoft/samples'} | ${'https://github.com/khulnasoft/samples/'}
