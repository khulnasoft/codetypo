...
export const definitions: FileTypeDefinitions = [
    ...
    { id: 'c', extensions: ['.c', '.i'] },
    { id: 'cache_files', extensions: [], filenames: ['.DS_Store', '.codetypocache', '.eslintcache'] },
    ...
    { id: 'trie', extensions: ['.trie'], format: 'Binary', description: 'CodeTypo dictionary file.' },
...
// codetypo:ignoreRegExp /id: '.*?'/g
// codetypo:ignoreRegExp /extensions: \[[^\]]*?\]/g
// codetypo:ignoreRegExp /filenames: \[[^\]]*?\]/g
// codetypo:ignore SPSS
