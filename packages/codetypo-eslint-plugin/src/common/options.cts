import type { CodeTypoSettings, DictionaryDefinitionPreferred } from '@codetypo/codetypo-types';
...
export interface Options extends Check {
    ...
    /**
     * Output debug logs to `.codetypo-eslint-plugin.log`
     * default false
     */
    debugMode?: boolean;
}
...
export type CodeTypoOptions = Pick<
    CodeTypoSettings,
    // | 'languageSettings'
    // | 'overrides'
    | 'allowCompoundWords'
...
export interface Check {
    ...
    configFile?: string;
    /**
     * CodeTypo options to pass to the spell checker.
     */
    codetypo?: CodeTypoOptions;
    /**
