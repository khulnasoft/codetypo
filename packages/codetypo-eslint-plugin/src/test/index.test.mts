...
// codetypo:ignore configg cityssm
...
ruleTester.run('codetypo', Rule.rules.spellchecker, {
    valid: [
        ...
        readFix('with-errors/auto-fix.ts', {
            ...
            configFile: resolveFix('codetypo.test.config.yaml'),
        }),
    ...
    invalid: [
        // codetypo:ignore Guuide Gallaxy BADD functionn coool
        ...
        readInvalid(
            ...
            { codetypo: { ignoreRegExpList: ['/\\bGuuide\\b/g'] } },
        ),
        readInvalid(
            'with-errors/sampleESM.mjs',
        ...
        // codetypo:ignore Montj Todayy Yaar Aprill Februarry gooo weeek
        ...
        // codetypo:ignore naaame doen't isssues playy
        ...
        // codetypo:ignore muawhahaha grrrrr uuuug
        readInvalid(
        ...
        // codetypo:ignore GRRRRRR UUUUUG
        readInvalid(
        ...
        // codetypo:ignore bestbusiness friendz
        ...
        readInvalid('issue-4870/sample.js', ['Unknown word: "friendz"'], {
            codetypo: { allowCompoundWords: true },
        }),
        readInvalid(
            'simple/sample.ts',
