...
ruleTester.run('codetypo', Rule.rules.spellchecker, {
    ...
    invalid: [
        // codetypo:ignore readstring resetmemorycategory retargeting rrotate rshift
        readInvalid(
            ...
            {
                configFile: resolveFix('import-support/codetypo.test.json'),
            },
        ),
        readInvalid(
            'import-support/sample.ts',
        ...
        readInvalid(
            ...
            {
                codetypoOptionsRoot: 'eslint-test-configuration-file',
                codetypo: {
