...
import type { Issue } from '@codetypo/codetypo-types';

import type { CodeTypoConfigFile, LinterCliOptions, LinterOptions } from '../options.js';
...
export class LintRequest {
    ...
    readonly configFile: string | CodeTypoConfigFile | undefined;
