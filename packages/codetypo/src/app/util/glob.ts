...
import type { CodeTypoUserSettings, Glob } from '@codetypo/codetypo-types';
import type { GlobPatternWithRoot } from 'codetypo-glob';
import { fileOrGlobToGlob, GlobMatcher } from 'codetypo-glob';
import type { GlobOptions as TinyGlobbyOptions } from 'tinyglobby';
import { glob } from 'tinyglobby';

import { clean } from './util.js';

// codetypo:ignore tinyglobby
...
export interface GlobOptions {
    ...
    nodir?: boolean | undefined; // codetypo:ignore nodir
