import type { CodeTypoReporter, Issue, ProgressItem, RunResult } from '@codetypo/codetypo-types';
 ...
 */
export class InMemoryReporter implements CodeTypoReporter, InMemoryResult {
    log: string[] = [];
    errors: Error[] = [];
    issueCount = 0;
    errorCount = 0;
