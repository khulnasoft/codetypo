...
import type { CachedFileResult, CodeTypoCacheMeta } from './DiskCache.js';
...
function entry(result: CachedFileResult, dependencies: string[] = [], size = 100): { meta: CodeTypoCacheMeta } {
    return {
        meta: {
            size,
            data: {
