...
interface CodeTypoCachedMetaData {
    data?: CachedData;
}

type Meta = FileDescriptor['meta'];

export type CodeTypoCacheMeta = (Meta & CodeTypoCachedMetaData) | undefined;
 ...
 * This is used in combination with the Suffix and the version of CodeTypo.
 */
...
/**
 * Caches codetypo results on disk
 */
export class DiskCache implements CodeTypoLintResultCache {
    ...
    constructor(
        ...
        readonly codetypoVersion: string,
        ...
        this.version = calcVersion(codetypoVersion);
    }
    ...
    public async getCachedLintResults(filename: string): Promise<FileResult | undefined> {
        ...
        const meta = fileDescriptor.meta as CodeTypoCacheMeta;
        ...
        // 3. The CodeTypo configuration has not changed since the time the file was previously linted
