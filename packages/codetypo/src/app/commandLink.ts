...
export function commandLink(prog: Command): Command {
    const linkCommand = prog
        .command('link')
        .description('Link dictionaries and other settings to the codetypo global config.');
    ...
    linkCommand
        ...
        .alias('a')
        .description('Add dictionaries any other settings to the codetypo global config.')
