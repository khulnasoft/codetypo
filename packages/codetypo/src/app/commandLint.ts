...
export function commandLint(prog: Command): Command {
    ...
    spellCheckCommand
        ...
        .option(
            '-c, --config <codetypo.json>',
            'Configuration file to use.  By default codetypo looks for codetypo.json in the current directory.',
        )
        ...
        .option('--validate-directives', 'Validate in-document CodeTypo directives.')
        .addOption(crOpt('--no-validate-directives', 'Do not validate in-document CodeTypo directives.').hideHelp())
        ...
        .option('--debug', 'Output information useful for debugging codetypo.json files.')
