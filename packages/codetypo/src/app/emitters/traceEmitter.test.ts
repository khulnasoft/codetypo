...
errorcode  - softwareTerms*    node_modules/@codetypo/.../dict/softwareTerms.txt`);
    });
...
errorcode  - softwareTerms*    D:/this_is_a_very/long/path/node_modules/@codetypo/dict-software-terms/dict/softwareTerms.txt`,
            ),
        );
    });
});
...
const _sampleResults: TraceResult[] = [
    {
        word: 'errorcode', // codetypo:ignore errorcode
        found: true,
    ...
    },
    {
        ...
        dictActive: true,
        dictSource: '/this_is_a_very/long/path/node_modules/@codetypo/dict-software-terms/dict/softwareTerms.txt',
        configSource: 'the config source',
        preferredSuggestions: undefined,
        errors: undefined,
    },
