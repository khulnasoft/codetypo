...
**Note:** Version bump only for package codetypo
...
* add --cache-reset option ([#2677](https://github.com/khulnasoft/codetypo/issues/2677)) ([631073b](https://github.com/khulnasoft/codetypo/commit/631073b42f24dec00eed9740cb8ee2e5bce4b07f))
...
- Update CHANGELOG.md ([#1291](https://github.com/khulnasoft/codetypo/issues/1291)) ([7129c1b](https://github.com/khulnasoft/codetypo/commit/7129c1bdaa107ae8990ecf8ca2120e82031f2c05))

# [5.5.0](https://github.com/khulnasoft/codetypo/compare/v5.4.1...v5.5.0) (2021-05-29)

### Features

- Remove incorrect Ignore Hex Digits Regexp ([#1277](https://github.com/khulnasoft/codetypo/issues/1277)) ([2621eb0](https://github.com/khulnasoft/codetypo/commit/2621eb02f487d9e466b4936bde8650c338b320b8)), closes [#1276](https://github.com/khulnasoft/codetypo/issues/1276)

  Minor **BREAKING** change.

  `codetypo` used to ignore all words that had just hex characters `[a-f]`. This lead to issues like [#1276](https://github.com/khulnasoft/codetypo/issues/1276). `codetypo` will no longer ignore words with only hex characters. To avoid load of false positives (cases where a hex number was intended)
...
- file globs listed on the command line override files in the config. ([#1117](https://github.com/khulnasoft/codetypo/issues/1117)) ([25c501d](https://github.com/khulnasoft/codetypo/commit/25c501d2267b8aca93624e0c4e036df5fdef7d20)), closes [#1115](https://github.com/khulnasoft/codetypo/issues/1115)
...
## [5.3.7-alpha.1](https://github.com/khulnasoft/codetypo/compare/v5.3.7-alpha.0...v5.3.7-alpha.1) (2021-03-05)
...
- make sure glob patterns match on windows ([#1039](https://github.com/khulnasoft/codetypo/issues/1039)) ([1e58e4c](https://github.com/khulnasoft/codetypo/commit/1e58e4c0c1fb706fc61fb82512d6fe92ad0b58fc))
...
- make sure to export all needed codetypo types. ([#1006](https://github.com/khulnasoft/codetypo/issues/1006)) ([c625479](https://github.com/khulnasoft/codetypo/commit/c625479be185f287e297a1dcddbcfa2aa24b0d0d))
...
- [#1000](https://github.com/khulnasoft/codetypo/issues/1000) ([#1002](https://github.com/khulnasoft/codetypo/issues/1002)) ([d82a4a2](https://github.com/khulnasoft/codetypo/commit/d82a4a2921fd70a790d8b0839e6be6f342501c26))
...
- Glob patterns are relative to the config file. ([#921](https://github.com/khulnasoft/codetypo/issues/921)) ([a250448](https://github.com/khulnasoft/codetypo/commit/a2504484ec38f15804cc0a203317266f83566b7c))
...
- remove dependency upon `@types/glob` ([#810](https://github.com/khulnasoft/codetypo/issues/810)) ([03fab52](https://github.com/khulnasoft/codetypo/commit/03fab5288d971ced4c49da6765194653d8f73f96))
...
- Docs and minor edits ([#757](https://github.com/khulnasoft/codetypo/issues/757)) ([e5f4567](https://github.com/khulnasoft/codetypo/commit/e5f4567f25a90ee52105e50c99c7ad90cfb9fdb0))
- issue with importing codetypo ([ff32d0c](https://github.com/khulnasoft/codetypo/commit/ff32d0cab987026e13d131961667e10b6cd83831))
...
- Expose Emitter types ([#718](https://github.com/khulnasoft/codetypo/issues/718)) ([3ef9030](https://github.com/khulnasoft/codetypo/commit/3ef903097de0819025ba74eb9bf978eb1f57fc12))
...
- make sure the error code is correctly set ([#619](https://github.com/khulnasoft/codetypo/issues/619)) ([09e358c](https://github.com/khulnasoft/codetypo/commit/09e358c3b7d3c485df92d7d9c5a652cf6a85f635))
...
## [5.0.1-alpha.0](https://github.com/khulnasoft/codetypo/compare/codetypo@4.0.44...codetypo@5.0.1-alpha.0) (2020-02-20)
...
- [Resolve paths beginning with tilde as \$HOME by `tribut` · Pull Request #83](https://github.com/khulnasoft/codetypo/pull/83)
- Fixed: [English words between Japanese characters are not correctly checked. · Issue #89](https://github.com/khulnasoft/codetypo/issues/89)
...
- codetypo-cli: Added option to not show the summary at the end.
...
- Moved the companies dictionary to [codetypo-dicts/packages/companies](https://github.com/khulnasoft/codetypo-dicts/tree/main/packages/companies)
- Updated Tooling
...
- Add `Elixir` dictionary to codetypo.

## [3.1.2]

- Add `lorem-ipsum` dictionary to codetypo.

## [3.1.1]

- Fix [Can't set language via config file #49](https://github.com/khulnasoft/codetypo/issues/49)

## [3.1.0]

- Change the default output for issues to address: [linter output format is not standardized #35](https://github.com/khulnasoft/codetypo/issues/35).
...
- `check` command now supports overrides in the `codetypo.json` file.
...
- Do not crash if configstore is not available. [Server crashes on Ubuntu #207](https://github.com/khulnasoft/vscode-spell-checker/issues/207)
...
- Fix an issue with matching too much text for a url:
  [Misspelled first word after HTML element with absolute URL is not detected #201](https://github.com/khulnasoft/vscode-spell-checker/issues/201)
- [Better LaTeX support](https://github.com/khulnasoft/vscode-spell-checker/issues/167#issuecomment-373682530)
...
- Make codeTypo aware of AsciiDocs.
...
- Migrate LaTex to codetypo-dicts
...
- Fix [String Regex too greedy](https://github.com/khulnasoft/vscode-spell-checker/issues/185)

## [2.1.3]

- Make sure title, section, etc. is spell checked: [LaTeX: No spell check for chapter/section titles #179](https://github.com/khulnasoft/vscode-spell-checker/issues/179)

## [2.1.2]

- Add dictionary for Rust
- Improved LaTex macro detection based upon [Bludkey's suggestion](https://github.com/khulnasoft/vscode-spell-checker/issues/172#issuecomment-366523937)
- Improved verbose output by displaying the language detected and dictionaries used.
- Updated `cpp` dictionary to address: [incorrect spelling of "successful"](https://github.com/khulnasoft/vscode-spell-checker/issues/176)

## [2.1.1]

- Add the ability to ignore the next line or the current line: `codetypo:disable-line` and `codetypo:disable-next-line`
  See [No spell-checker:disable-line](https://github.com/khulnasoft/codetypo/issues/24)
...
- Correct the CodeTypoUserSettings interface for compatibility
...
- Use `configstore-fork` to enable codetypo usage in a CI environment [#25](https://github.com/khulnasoft/codetypo/issues/25)
...
- Migrate PHP dictionary file to [codetypo-dict](https://github.com/khulnasoft/codetypo-dicts)
- Migrate C++ dictionary file to [codetypo-dict](https://github.com/khulnasoft/codetypo-dicts)
...
- Fix [#16](https://github.com/khulnasoft/codetypo/issues/16) where words beginning with capitol letters were not getting good suggestions.
...
- Migrate Go Lang dictionary file to [codetypo-dict](https://github.com/khulnasoft/codetypo-dicts)
- Migrate Python dictionary file to [codetypo-dict](https://github.com/khulnasoft/codetypo-dicts)
...
- Fix issue [#10](https://github.com/khulnasoft/codetypo/issues/10) - handle right quotes.
...
- The two English dictionaries have been moved into [codetypo-dict](https://github.com/khulnasoft/codetypo-dicts) for easier maintenance.
- It is now possible to import other settings files from with in a codetypo.json file using `"import": ["../path/to/other/codetypo.json"]`
...
- Support the new codetypo-trie file format. This is useful for very large dictionaries.

## 1.3.3

- Use latest version of codetypo-tools.
...
- Fixed and issue with the codetypo.json loading
...
<!-- codetypo:ignore appveyor Bludkey's tribut -->
