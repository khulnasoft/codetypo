...
import { CodeTypoConfigFile, ICodeTypoConfigFile } from 'codetypo-config-lib';
export { CodeTypoConfigFile, ICodeTypoConfigFile } from 'codetypo-config-lib';
...
declare function getVirtualFS(): codetypo_io.VirtualFS;
...
declare const SymbolCodeTypoSettingsInternal: unique symbol;
interface CodeTypoSettingsInternal extends Omit<AdvancedCodeTypoSettingsWithSourceTrace, 'dictionaryDefinitions'> {
    [SymbolCodeTypoSettingsInternal]: true;
    dictionaryDefinitions?: DictionaryDefinitionInternal[];
}
interface CodeTypoSettingsInternalFinalized extends CodeTypoSettingsInternal {
 ...
 */
declare function getDictionary(settings: CodeTypoUserSettings): Promise<SpellingDictionaryCollection>;
...
type CodeTypoSettingsWST$1 = AdvancedCodeTypoSettingsWithSourceTrace;
type CodeTypoSettingsWSTO = OptionalOrUndefined<AdvancedCodeTypoSettingsWithSourceTrace>;
type CodeTypoSettingsI$1 = CodeTypoSettingsInternal;

declare function mergeSettings(left: CodeTypoSettingsWSTO | CodeTypoSettingsI$1, ...settings: (CodeTypoSettingsWSTO | CodeTypoSettingsI$1 | undefined)[]): CodeTypoSettingsI$1;
declare function mergeInDocSettings(left: CodeTypoSettingsWSTO, ...rest: CodeTypoSettingsWSTO[]): CodeTypoSettingsWST$1;
/**
 *
 * @param settings - settings to finalize
 * @returns settings where all globs and file paths have been resolved.
 */
declare function finalizeSettings(settings: CodeTypoSettingsWSTO | CodeTypoSettingsI$1): CodeTypoSettingsInternalFinalized;
/**
 * Return a list of Setting Sources used to create this Setting.
 * @param settings the settings to search
 */
declare function getSources(settings: CodeTypoSettingsWSTO): CodeTypoSettingsWSTO[];
...
declare function extractDependencies(settings: CodeTypoSettingsWSTO | CodeTypoSettingsI$1): ConfigurationDependencies;

declare function calcOverrideSettings(settings: CodeTypoSettingsWSTO, filename: string): CodeTypoSettingsI$1;
...
declare const ENV_CODETYPO_GLOB_ROOT = "CODETYPO_GLOB_ROOT";
...
type CodeTypoSettingsWST = CodeTypoSettingsWithSourceTrace;
type CodeTypoSettingsI = CodeTypoSettingsInternal;

declare const sectionCodeTypo = "codeTypo";
declare const defaultFileName = "codetypo.json";
interface IConfigLoader {
    readSettingsAsync(filename: string | URL, relativeTo?: string | URL, pnpSettings?: PnPSettingsOptional): Promise<CodeTypoSettingsI>;
    /**
     ...
     */
    searchForConfig(searchFrom: URL | string | undefined, pnpSettings?: PnPSettingsOptional): Promise<CodeTypoSettingsI | undefined>;
     ...
     */
    mergeConfigFileWithImports(cfgFile: CodeTypoConfigFile, pnpSettings?: PnPSettingsOptional | undefined): Promise<CodeTypoSettingsI>;
    /**
 ...
 * @returns the resulting settings
 */
declare function searchForConfig(searchFrom: URL | string | undefined, pnpSettings?: PnPSettingsOptional): Promise<CodeTypoSettingsI | undefined>;
/**
 ...
 */
declare function loadConfig(file: string, pnpSettings?: PnPSettingsOptional): Promise<CodeTypoSettingsI>;
declare function readConfigFile(filename: string | URL, relativeTo?: string | URL): Promise<CodeTypoConfigFile>;
declare function resolveConfigFileImports(configFile: CodeTypoConfigFile | ICodeTypoConfigFile): Promise<CodeTypoSettingsI>;
/**
 * Might throw if the settings have not yet been loaded.
 * @deprecated use {@link getGlobalSettingsAsync} instead.
 */
declare function getGlobalSettings(): CodeTypoSettingsI;
/**
 * Loads and caches the global settings.
 * @returns - global settings
 */
declare function getGlobalSettingsAsync(): Promise<CodeTypoSettingsI>;
declare function getCachedFileSize(): number;
declare function getDefaultConfigLoader(): IConfigLoader;
declare function readRawSettings(filename: string | URL, relativeTo?: string | URL): Promise<CodeTypoSettingsWST>;

declare function extractImportErrors(settings: CodeTypoSettingsWST): ImportFileRefWithError[];
 ...
 */
declare function readSettings(filename: string | URL): Promise<CodeTypoSettingsI>;
declare function readSettings(filename: string | URL, pnpSettings: PnPSettingsOptional): Promise<CodeTypoSettingsI>;
/**
 * Read / import a codetypo configuration file.
 * @param filename - the path to the file.
 *   Supported types: json, yaml, js, and cjs. ES Modules are not supported.
 ...
 */
declare function readSettings(filename: string | URL, relativeTo: string | URL): Promise<CodeTypoSettingsI>;
declare function readSettings(filename: string | URL, relativeTo: string | URL, pnpSettings: PnPSettingsOptional): Promise<CodeTypoSettingsI>;
 ...
 * @deprecated true
 */
declare function readSettingsFiles(filenames: string[]): Promise<CodeTypoSettingsI>;
...
declare function getDefaultSettings(useDefaultDictionaries?: boolean): Promise<CodeTypoSettingsInternal>;
declare function getDefaultBundledSettingsAsync(): Promise<CodeTypoSettingsInternal>;
...
interface ListGlobalImportsResult {
    ...
    dictionaryDefinitions: CodeTypoSettingsWithSourceTrace['dictionaryDefinitions'];
    languageSettings: CodeTypoSettingsWithSourceTrace['languageSettings'];
    package: NodePackage | undefined;
}
interface ListGlobalImportsResults {
    list: ListGlobalImportsResult[];
    globalSettings: CodeTypoSettingsWithSourceTrace;
}
...
interface ResolveSettingsResult {
    ...
    error?: string;
    settings: CodeTypoSettingsWithSourceTrace;
}
...
declare function combineTextAndLanguageSettings(settings: CodeTypoUserSettings, text: string | undefined, languageId: string | string[]): CodeTypoSettingsInternal;
...
declare function suggestionsForWords(words: Iterable<string> | AsyncIterable<string>, options?: SuggestionOptions, settings?: CodeTypoSettings): AsyncIterable<SuggestionsForWordResult>;
declare function suggestionsForWord(word: string, options?: SuggestionOptions, settings?: CodeTypoSettings | ICodeTypoConfigFile): Promise<SuggestionsForWordResult>;
...
interface DocumentValidatorOptions extends ValidateTextOptions {
    ...
    /**
     * If `settings: CodeTypoUserSettings` contains imports, they will be resolved using this path.
...
declare class DocumentValidator {
    readonly settings: CodeTypoUserSettings;
    private _document;
    private _ready;
    ...
    skipValidation: boolean;
    static create(doc: TextDocument, options: DocumentValidatorOptions, settingsOrConfigFile: CodeTypoUserSettings | ICodeTypoConfigFile): Promise<DocumentValidator>;
    /**
     * @param doc - Document to validate
     * @param config - configuration to use (not finalized).
     */
    constructor(doc: TextDocument, options: DocumentValidatorOptions, settings: CodeTypoUserSettings);
    get ready(): boolean;
    ...
    getFinalizedDocSettings(): CodeTypoSettingsInternal;
    /**
     ...
     * might still make sense, for example, the `@codetypo/eslint-plugin` relies on
...
declare function shouldCheckDocument(doc: TextDocumentRef, options: DocumentValidatorOptions, settings: CodeTypoUserSettings): Promise<ShouldCheckDocumentResult>;
 ...
 * @deprecated
 */
declare function checkText(text: string, settings: CodeTypoUserSettings): Promise<CheckTextInfo>;
 ...
 * @returns
 */
declare function checkTextDocument(doc: TextDocument | Document, options: CheckTextOptions, settings?: CodeTypoUserSettings): Promise<CheckTextInfo>;

/**
 * @deprecated
 * @deprecationMessage Use spellCheckDocument
 */
declare function validateText(text: string, settings: CodeTypoUserSettings, options?: ValidateTextOptions): Promise<ValidationIssue[]>;
...
interface SpellCheckFileResult {
    ...
    settingsUsed: CodeTypoSettingsWithSourceTrace;
    localConfigFilepath: string | undefined;
 ...
 */
declare function spellCheckFile(file: string | Uri | URL, options: SpellCheckFileOptions, settingsOrConfigFile: CodeTypoUserSettings | ICodeTypoConfigFile): Promise<SpellCheckFileResult>;
/**
 ...
 * @param settings - default settings to use.
 */
declare function spellCheckDocument(document: Document | DocumentWithText, options: SpellCheckFileOptions, settingsOrConfigFile: CodeTypoUserSettings | ICodeTypoConfigFile): Promise<SpellCheckFileResult>;
 ...
 * It is NOT necessary to include the codetypo defaultSettings or globalSettings. They will be applied within this function.
 ...
 */
declare function determineFinalDocumentSettings(document: DocumentWithText, settings: CodeTypoUserSettings): Promise<DetermineFinalDocumentSettingsResult>;
...
declare function traceWords(words: string[], settings: CodeTypoSettings | ICodeTypoConfigFile, options: TraceOptions | undefined): Promise<TraceResult[]>;
declare function traceWordsAsync(words: Iterable<string> | AsyncIterable<string>, settingsOrConfig: CodeTypoSettings | ICodeTypoConfigFile, options: TraceOptions | undefined): AsyncIterableIterator<TraceWordResult>;
