...
import type { CodeTypoSettings, LocaleId } from '@codetypo/codetypo-types';
...
const emptyCodeTypoSettings = Object.freeze({});
...
async function _suggestionsForWord(
    ...
    async function determineDictionaries(config: CodeTypoSettings): Promise<{
...
function validateDictionaries(settings: CodeTypoSettings, dictionaries: string[] | undefined) {
