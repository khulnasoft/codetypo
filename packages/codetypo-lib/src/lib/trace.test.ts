...
describe('Verify trace', () => {
    ...
    // codetypo:ignore *error* *code* hte colour colum
    test.each`
...
async function getSettings(...settings: CodeTypoSettings[]): Promise<CodeTypoSettings> {
