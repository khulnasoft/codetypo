...
import type { DictionaryDefinition, DictionaryDefinitionLegacy } from '@codetypo/codetypo-types';
...
describe('Validate DictionarySettings', () => {
    ...
    test('tests normalizing home dir', () => {
        const pathToConfig = pathToFileURL('./codetypo.json');
    ...
    test('Double normalize', () => {
        const configFile = pathToFileURL('./codetypo.json');
        const def: DictionaryDefinition = {
            name: 'Text Dict',
            path: './words.txt',
        };
