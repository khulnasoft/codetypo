import type { PredefinedPatterns, RegExpPatternDefinition } from '@codetypo/codetypo-types';
import { parsers } from 'codetypo-grammar';

import type { CodeTypoSettingsInternal } from '../Models/CodeTypoSettingsInternalDef.js';
import { createCodeTypoSettingsInternal } from '../Models/CodeTypoSettingsInternalDef.js';
...
export const _defaultSettingsBasis: Readonly<CodeTypoSettingsInternal> = Object.freeze(
    createCodeTypoSettingsInternal({
        id: 'static_defaults',
        language: 'en',
...
export const _defaultSettings: Readonly<CodeTypoSettingsInternal> = Object.freeze(
    createCodeTypoSettingsInternal({
...
class DefaultSettingsLoader {
    settings: CodeTypoSettingsInternal | undefined = undefined;
    pending: Promise<CodeTypoSettingsInternal> | undefined = undefined;
    ...
    getDefaultSettingsAsync(useDefaultDictionaries = true): Promise<CodeTypoSettingsInternal> {
...
export function getDefaultSettings(useDefaultDictionaries = true): Promise<CodeTypoSettingsInternal> {
    return defaultSettingsLoader.getDefaultSettingsAsync(useDefaultDictionaries);
}

export function getDefaultBundledSettingsAsync(): Promise<CodeTypoSettingsInternal> {
