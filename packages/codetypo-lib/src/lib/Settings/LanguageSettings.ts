...
import * as SpellSettings from './CodeTypoSettingsServer.js';
...
export function calcUserSettingsForLanguage(settings: CodeTypoUserSettings, languageId: string): CodeTypoUserSettings {
...
export function calcSettingsForLanguageId(
    baseSettings: CodeTypoUserSettings,
