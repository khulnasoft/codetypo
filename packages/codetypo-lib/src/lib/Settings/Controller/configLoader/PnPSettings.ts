import type { CodeTypoSettings, PnPSettings } from '@codetypo/codetypo-types';
 ...
 * @returns
 */
export function normalizePnPSettings(settings: PnPSettingsOptional | CodeTypoSettings): PnPSettings {
