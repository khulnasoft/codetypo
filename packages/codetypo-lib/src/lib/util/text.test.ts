...
import { opConcatMap, pipe, toArray } from '@codetypo/codetypo-pipe/sync';
import type { TextOffset } from '@codetypo/codetypo-types';
import { urlRelative } from '@codetypo/url';
...
// codeTypo:ignore Ápple DBAs ctrip γάμμα
...
describe('Test the text matching functions', () => {
    ...
    // codeTypo:ignore áello firstname
    test('ucFirst', () => {
