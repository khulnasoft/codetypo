...
import { resolveGlobal } from '@codetypo/codetypo-resolver';
import { importResolveModuleName } from '@codetypo/dynamic-import';
import type { VFileSystem } from 'codetypo-io';
