 ...
 * @deprecated
 */
export async function checkText(text: string, settings: CodeTypoUserSettings): Promise<CheckTextInfo> {
 ...
 * @deprecated
 */
export async function checkTextOld(text: string, settings: CodeTypoUserSettings): Promise<CheckTextInfo> {
