...
import { createCollection, createSpellingDictionary, createSuggestDictionary } from 'codetypo-dictionary';
...
describe('lineValidatorFactory', () => {
    // codetypo:ignore 𐀀𐃘 izfrNTmQLnfsLzi2Wb9x izfr Lnfs Drived
    ...
    // codetypo:ignore adab AFDA eefcb opclasses charmodel relationmodel deadfee
