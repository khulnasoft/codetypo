...
// codeTypo:ignore brouwn jumpped lazzy wrongg mispelled ctrip nmove mischecked
...
describe('Validator', () => {
    ...
    // codetypo:ignore hellosd applesq bananasa respectss
    test('Issue #7', async () => {
    ...
    // codetypo:ignore witth feww mistaks
    ...
    // codetypo:ignore grappes colour
    test.each`
        text              | expected
        ${'hello'}        | ${[]}
...
// codetypo:ignore behaviour
const rejectWords = ['!colour', '!behaviour', '!favour'];

// codetypo:ignore crazzzy wordz
...
const sampleCodeTypo: CodeTypoSettings = {
    ..._defaultSettings,
    version: '0.2',
    flagWords,
    words,
...
function sampleSettings() {
    return Object.freeze({ ...sampleCodeTypo });
}
