...
import type { SpellingDictionary, SpellingDictionaryCollection } from 'codetypo-dictionary';
import {
    createCollection,
...
} from 'codetypo-dictionary';

import type { CodeTypoSettingsInternal, DictionaryDefinitionInternal } from '../Models/CodeTypoSettingsInternalDef.js';
...
export async function getDictionaryInternal(settings: CodeTypoSettingsInternal): Promise<SpellingDictionaryCollection> {
...
export function getInlineConfigDictionaries(settings: CodeTypoSettings): SpellingDictionary[] {
    const {
        words = emptyWords,
...
function _getDictionaryInternal(
    settings: CodeTypoSettingsInternal,
