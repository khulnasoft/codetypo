...
import { FileUrlBuilder } from '@codetypo/url';
...
describe('Tests .gitignore file contents', () => {
  const pattern = `
        ...
        **/temp/**
        /**/temp-local/**
    `;
  const root = '/Users/code/project/codetypo/';
  const nonRoot = '/Users/guest/code/';
  // codetypo:ignore nobrace
  ...
  test.each`
    ...
    ${root + 'node_modules/codetypo/code.ts'}        | ${true}                                                           | ${'Ensure that node modules are not allowed in the current root.'}
    ${root + 'nested/node_modules/codetypo/code.ts'} | ${false}                                                          | ${'Ensure that nested node modules are allowed in the current root.'}
    ${nonRoot + 'node_modules/codetypo/code.ts'}     | ${false}                                                          | ${'Ensure that node modules in a different root are allowed'}
...
describe('Tests .gitignore like file contents', () => {
  ...
  test.each`
    ...
    ${root + 'node_modules/codetypo/code.ts'}                 | ${true}                                                           | ${'Ensure that node modules are not allowed in the current root.'}
    ${root + 'nested/node_modules/codetypo/code.ts'}          | ${false}                                                          | ${'Ensure that nested node modules are allowed in the current root.'}
    ${'/Users/guest/code/' + 'node_modules/codetypo/code.ts'} | ${false}                                                          | ${'Ensure that node modules in a different root are allowed'}
    ${root + 'settings.js'}                                   | ${false}                                                          | ${'Ensure that settings.js is kept'}
    ${root + 'dist/settings.js'}                              | ${false}                                                          | ${'Ensure that settings.js is kept'}
    ${root + 'node_modules/settings.js'}                      | ${false}                                                          | ${'Ensure that settings.js is kept'}
    ${root + 'src.txt'}                                       | ${true}                                                           | ${'Ensure that double negative means block'}
...
describe('Validate Options', () => {
  ...
  `('options: $pattern, $file, $options, root', ({ pattern, file, options, root, expected }: TestCase) => {
    root = root || '/Users/code/project/codetypo/';
...
describe('normalizing globs', () => {
  ...
  test.each`
    ...
    ${'/docs/types/codetypo-types'} | ${gitRoot}        | ${gitRoot}        | ${['docs/types/codetypo-types', 'docs/types/codetypo-types/**']} | ${r(gitRoot, './docs/types/codetypo-types/assets/main.js')} | ${true}
...
function tests(): TestCase[] {
  ...
  const testCases: TestCase[] = [
    ...
    [['${cwd}/node_modules/'], gitRoot, 'node_modules/codetypo/', true, 'node_modules/'],
