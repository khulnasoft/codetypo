export interface RunConfig extends Partial<CompileRequest> {
    /**
     * Url to JSON Schema
     * @default "https://raw.githubusercontent.com/khulnasoft/codetypo/main/packages/codetypo-tools/codetypo-tools.config.schema.json"
     */
    $schema?: string;
...
export interface CompileTargetOptions {
    ...
    /**
     * Injects `codetypo-dictionary` directives into the dictionary header.
     *
     * Example:
     *
     * ```ini
     * # codetypo-dictionary: no-generate-alternatives
     * ```
     *
     * Known Directives:
     * ```yaml
...
export const configFileSchemaURL =
    'https://raw.githubusercontent.com/khulnasoft/codetypo/main/packages/codetypo-tools/codetypo-tools.config.schema.json';
