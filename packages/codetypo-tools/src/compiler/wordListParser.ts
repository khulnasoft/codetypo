import { opCombine, opCombine as opPipe, type Operator, opFilter, opMap } from '@codetypo/codetypo-pipe/sync';
import { createDictionaryLineParser } from 'codetypo-trie-lib';
...
export const codeTypoToolDirective = 'codetypo-tools:';

export const setOfCodeTypoDirectiveFlags = ['no-split', 'split', 'keep-case', 'no-keep-case', 'legacy'];
