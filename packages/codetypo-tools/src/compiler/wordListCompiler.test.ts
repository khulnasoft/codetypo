// codeTypo:ignore jpegs outing dirs lcode outring outrings

import * as fsp from 'node:fs/promises';
import * as path from 'node:path';

import { opConcatMap, opTake, pipe, toArray } from '@codetypo/codetypo-pipe/sync';
import * as Trie from 'codetypo-trie-lib';
import { importTrie, isCircular, iteratorTrieWords, serializeTrie } from 'codetypo-trie-lib';
...
describe('Validate the wordListCompiler', () => {
    ...
    `('reading and normalizing to text file: $destFile', async ({ destFile }) => {
        ...
        const expected = '\n# codetypo-tools: keep-case no-split\n\n' + source.join('\n') + '\n';
