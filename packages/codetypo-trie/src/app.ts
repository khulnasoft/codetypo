...
export async function run(program: Command, argv: string[]): Promise<Command> {
    ...
    program.version(version).name('codetypo-trie');
    ...
    program
        ...
        .description('Generate a file for use with codetypo')
    ...
    program
        ...
        .option('-o, --output <file>', 'output file - defaults to stdout')
        .description('Read a codetypo trie file and output the list of words.')
        .action(async (filename, options) => {
