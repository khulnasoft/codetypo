...
Trie library for use with codetypo
...
_codetypo-trie_ is both a tool and a library.

Give a list of words, _codetypo-trie_ will turn it into a _trie_ file.

### Installation

```sh
npm install -g codetypo-trie
```
...
```sh
codetypo-trie create filename.txt -o filename.trie
```

### Reading a _trie_ file

```sh
codetypo-trie reader filename.trie
```
