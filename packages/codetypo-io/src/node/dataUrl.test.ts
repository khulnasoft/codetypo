...
describe('dataUrl', () => {
    test.each`
        ...
        ${Buffer.from('Hello, World!')} | ${'text/plain'}             | ${[['filename', 'hello.txt']]} | ${'data:text/plain;filename=hello.txt;base64,SGVsbG8sIFdvcmxkIQ' /* codetypo:disable-line */}
        ${'☸☹☺☻☼☾☿'}                 | ${'text/plain'}             | ${undefined}                   | ${'data:text/plain;charset=utf-8;base64,4pi44pi54pi64pi74pi84pi-4pi_'}
        ${'Hello, World!'}              | ${'application/vnd.codetypo'} | ${undefined}                   | ${'data:application/vnd.codetypo;charset=utf-8,Hello%2C%20World!'}
    ...
    test.each`
        ...
        ${'data:text/plain;base64,SGVsbG8sIFdvcmxkIQ' /* codetypo:disable-line */}     | ${{ mediaType: 'text/plain', data: Buffer.from('Hello, World!'), attributes: new Map() }}
    ...
    test.each`
        ...
        ${'cities.trie'}    | ${{ mimeType: 'application/vnd.codetypo.dictionary+trie', encoding: 'utf-8' }}
        ${'cities.trie.gz'} | ${{ mimeType: 'application/vnd.codetypo.dictionary+trie.gz' }}
