...
export interface CodeTypoIO {
     ...
     * - `file:///user/project/codetypo.config.yaml` would have a filename of `codetypo.config.yaml`
     * - `https://raw.guc.com/sss/codetypo/main/codetypo.schema.json` would have a filename of `codetypo.schema.json`
