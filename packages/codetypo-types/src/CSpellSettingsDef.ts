import type { ReporterConfigurationBase } from './CodeTypoReporter.js';
 ...
 */
export type CodeTypoPackageSettings = CodeTypoUserSettings;

export type CodeTypoUserSettings = CodeTypoSettings;

export interface CodeTypoSettings extends FileSettings, LegacySettings {}
...
export interface CodeTypoSettingsWithSourceTrace extends CodeTypoSettings {
    source?: Source | undefined;
    __importRef?: ImportFileRef;
    __imports?: Map<string, ImportFileRef>;
}

export interface AdvancedCodeTypoSettingsWithSourceTrace
    extends CodeTypoSettingsWithSourceTrace,
        ExperimentalFileSettings {}

export interface FileSettings extends ExtendableSettings, CommandLineSettings {
    /**
     * Url to JSON Schema
     * @default "https://raw.githubusercontent.com/khulnasoft/codetypo/main/codetypo.schema.json"
     */
    $schema?: string;
     ...
     *
     * By default, CodeTypo does not scan `hidden` files.
     *
     * @default false
     */
     ...
     * - `["@codetypo/codetypo-json-reporter"]` - use the codetypo JSON reporter.
     * - `[["@codetypo/codetypo-json-reporter", { "outFile": "out.json" }]]`
     * - `[ "default", ["@codetypo/codetypo-json-reporter", { "outFile": "out.json" }]]` - Use both the default reporter and the codetypo-json-reporter.
     *
     * @default ["default"]
     */
 ...
 *
 * Trust setting have an impact on both `codetypo.config.js` files and on `.pnp.js` files.
 ...
 * when crafting codetypo.json files by hand.
 * @hidden
 */
...
export type CodeTypoUserSettingsWithComments = CodeTypoUserSettings;
...
export interface MergeSource extends BaseSource {
    ...
    filename?: undefined;
    /** The two settings that were merged to. */
    sources: [CodeTypoSettings] | [CodeTypoSettings, CodeTypoSettings];
    /** The configuration read. */
...
interface BaseSource {
    ...
    /** The two settings that were merged to. */
    sources?: [CodeTypoSettings] | [CodeTypoSettings, CodeTypoSettings] | undefined;
    /** The configuration read. */
    fileSource?: CodeTypoSettings | undefined;
}
...
/**
 * Extends CodeTypoSettings with {@link ExperimentalFileSettings}
 * @experimental
 * @hidden
 */
export interface AdvancedCodeTypoSettings extends CodeTypoSettings, ExperimentalFileSettings {}
