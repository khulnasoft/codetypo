...
describe('Test Aff', () => {
    ...
    it('tests applying rules for fr `avoir/180`', async () => {
        ...
        expect(w).toEqual(expect.arrayContaining(['n’avoir'])); // codetypo:ignore n’avoir
    ...
    it('tests applying rules for fr with maxDepth', async () => {
        ...
        expect(r0).toEqual(expect.not.arrayContaining(['n’avoir'])); // codetypo:ignore n’avoir
        ...
        expect(r1).toEqual(expect.arrayContaining(['n’avoir'])); // codetypo:ignore n’avoir
...
// codetypo:ignore moderne avoir huis pannenkoek ababillar CDSG ings
