...
describe('HunspellReader DE', function () {
    ...
    it('tests transforming a small dictionary', () => {
        ...
        // codetypo:ignore CEO BCO BCMO CMO CEMO
...
// codetypo:ignore Arbeit Arbeitsnehmer Computern
...
function deAff() {
    // codetypo:ignore COMPOUNDBEGIN COMPOUNDMIDDLE COMPOUNDEND COMPOUNDMIN WORDCHARS FORBIDDENWORD
    // codetypo:ignore fogemorpheme fogemorphemes fuge arbeits circumfix decapitalizing
    // codetypo:ignore VPDX VWXDP
    return `
# German compounding
