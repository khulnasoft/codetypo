...
describe('Basic Validation of the Reader', () => {
    ...
    it('Validates prefix/suffix/base', async () => {
        ...
        const someExpectedWords = ['<happy>', 'un<happy>', '<happ>ily', 'un<happ>ily']; // codetypo:ignore happ
    ...
    it('sets the max depth', async () => {
        ...
        const expectedWords = ['<happy>', '<ring>'].sort(); // codetypo:ignore happ
...
function getSimpleAff() {
    // codetypo:ignore esianrtolcdugmphbyfvkwzESIANRTOLCDUGMPHBYFVKWZ
    const sampleAff = `
SET UTF-8
...
// codetypo:ignore moderne avoir huis pannenkoek ababillar CDSG ings AUGJ aeiou sxzh sxzhy
// codetypo:words COMPOUNDMIN ONLYINCOMPOUND COMPOUNDRULE WORDCHARS
