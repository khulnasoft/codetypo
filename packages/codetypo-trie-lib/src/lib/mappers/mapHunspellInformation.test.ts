...
# codetypo:ignore asdfghjkl qwertyuiop zxcvbnm
KEY qwertyuiop|asdfghjkl|zxcvbnm
`;

describe('mapHunspellInformation', () => {
    // codetypo:ignore aàâä
    test.each`
        line                  | costs             | expected
        ${''}                 | ${{}}             | ${undefined}
    ...
    // codetypo:ignore qwér aasdfzxcv abcdéefghi
    test.each`
        line                    | costs                      | expected
        ${''}                   | ${{}}                      | ${undefined}
        ${'MAP aàâäAÀÂÄ'}       | ${{}}                      | ${undefined}
