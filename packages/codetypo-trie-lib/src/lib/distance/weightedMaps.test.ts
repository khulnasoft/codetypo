...
describe('Validate weightedMaps', () => {
    ...
    test.each`
        ...
        ${[]}                                                                   | ${''}     | ${1}   | ${[]}
        ${[defIns('aeiou', 7, penalty(5)), defIns('(ae)(ea)(ou)(ei)(ie)', 11)]} | ${'read'} | ${1}   | ${[{ i: 2, c: 7, p: 5 }, { i: 3, c: 11, p: 0 }] /* codetypo:disable-line */}
        ${[defIns('aeiou', 7, penalty(5)), defIns('(ae)(ea)(ou)(ei)(ie)', 11)]} | ${'read'} | ${2}   | ${[{ i: 3, c: 7, p: 5 }] /* codetypo:disable-line */}
