...
describe('Validate findWord', () => {
    ...
    const tests: [string, PartialFindOptions, FindFullResult][] = [
        ...
        // Legacy compounding
        // codetypo:ignore codeerrors errmsg errmsgerr
...
describe('Validate Legacy Compound lookup', () => {
    ...
    // codetypo:ignore walkin walkjay walkedge
    test.each`
    ...
    // codetypo:ignore cafecode codecafe
    test.each`
        word            | compoundLen | expected
        ${'codecafe'}   | ${true}     | ${true}
...
// codetypo:ignore blueerror bluecode
