...
describe('Validate Trie Class', () => {
    ...
    test('tests suggestions with compounds', () => {
        const trie = ITrie.create(sampleWords);
        // codetypo:ignore joyostalkliftswak
    ...
    test('compound words', () => {
        // codetypo:ignore talkinglift joywalk jwalk awalk jayjay jayi
        const trie = ITrie.create(sampleWords);
    ...
    test.each`
        ...
        ${'beginend'}                       | ${false}      | ${true}  | ${'codetypo:disable-line'}
        ${'playtime'}                       | ${true}       | ${false} | ${''}
        ${'playtime'}                       | ${false}      | ${false} | ${''}
        ${'playmiddletime'}                 | ${false}      | ${true}  | ${'codetypo:disable-line'}
    ...
    test('hasWord', () => {
        ...
        *time
        ...
        expect(trie.hasWord('playmiddletime', false)).toBe(true); // codetypo:disable-line
