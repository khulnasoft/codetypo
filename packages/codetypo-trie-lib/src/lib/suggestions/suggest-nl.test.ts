...
describe('Validate Dutch Suggestions', () => {
    ...
    // codetypo:ignore burtbewoners burgbewoners
    // codetypo:ignore buurtbwoners buurtbewoner buurbewoners
    // codetypo:ignore bultbewoners buutbewoners
    ...
    // codetypo:ignore buurt kasteloos kosten maan
    // codetypo:ignore baan buurbaan Buurma buurmans
    test.each`
        word             | expected
...
// codetypo:ignore conv OCONV
// codetypo:ignore aeiou positeve buurmaan buurman buurmaag buurmaat buurmaand beurt buur buut positie positieve
// codetypo:ignore positieven positiever positivo verklaaring verklaring wordt kosteloos kostelos kostenloos
