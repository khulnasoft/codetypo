import { DictionaryDefinition } from '@codetypo/codetypo-types';
...
describe('Validate Suggest', () => {
    ...
    // codetypo:ignore walkingtalkingjoy
    ...
    // codetypo:ignore joyfullwalk joyfulwalk joyfulwalks joyfullywalk, joyfullywalks
    ...
    // codetypo:ignore walking* *tree talking* *stick running* *pod *trick
    test.each`
...
function _getFastTrieBlob() {
    return readFastTrieBlobFromConfig('@codetypo/dict-en_us/codetypo-ext.json');
}
