...
describe('Validate English Suggestions', () => {
    ...
    // codetypo:ignore emplode ballence catagory dont
    test.each`
        word          | expected
    ...
    test(
        ...
        async () => {
            const trie = await getTrie();
            // codetypo:ignore onetwothreefour
    ...
    test(
        ...
        async () => {
            const trie = await getTrie();
            // codetypo:ignore onetwothrefour
    ...
    test(
        ...
        async () => {
            const trie = await getTrie();
            // codetypo:ignore testscomputesuggestions
    ...
    test(
        ...
        async () => {
            const trie = await getTrie();
            // codetypo:ignore testscompundsuggestions
...
const defaultDictInfo: DictionaryInformation = {
    ...
    suggestionEditCosts: [
        {
            map: 'aeiou', // codetypo:ignore aeiou
            replace: 50,
            insDel: 50,
            swap: 50,
        },
