...
function getTrie() {
    return readTrieFromConfig('@codetypo/dict-es-es/codetypo-ext.json');
}

describe('Validate Spanish Suggestions', () => {
    // codetypo:locale en,es
    // codetypo:ignore Carmjen
    // codetypo:disableCaseSensitive
    // codetypo:ignore barcelona carmjen nino
    test.each`
