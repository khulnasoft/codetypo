...
describe('Validate SimpleDictionaryParser', () => {
    ...
    // codetypo:ignore begin* *middle* *end
    const bme1 = [
        'beginmiddleend',
        'beginmiddleEnd',
        'beginMiddleend',
    ...
    // codetypo:ignore Midle beginmidleend gescháft cafë resumé agin
    test.each`
...
// codetypo:ignore Errormsg msgerror codecode codemsg errorerror
