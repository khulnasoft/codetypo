...
```sh
npm install -g @codetypo/dict-dotnet
codetypo link add @codetypo/dict-dotnet
```

## Uninstall from codetypo

```sh
codetypo link remove @codetypo/dict-dotnet
```
...
{
    // …
    "import": ["@codetypo/dict-dotnet/codetypo-ext.json"],
    // …
}
```
