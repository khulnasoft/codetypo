...
```sh
npm install -g @codetypo/dict-bg-bg
codetypo link add @codetypo/dict-bg-bg
```

## Uninstall from codetypo

```sh
codetypo link remove @codetypo/dict-bg-bg
```
...
{
    // …
    "import": ["@codetypo/dict-bg-bg/codetypo-ext.json"],
    // …
}
```
