...
```sh
npm install -g @codetypo/dict-latex
codetypo link add @codetypo/dict-latex
```

## Uninstall from codetypo

```sh
codetypo link remove @codetypo/dict-latex
```
...
{
    // …
    "import": ["@codetypo/dict-latex/codetypo-ext.json"],
    // …
}
```
