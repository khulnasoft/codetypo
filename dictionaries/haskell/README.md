...
```sh
npm install -g @codetypo/dict-haskell
codetypo link add @codetypo/dict-haskell
```

## Uninstall from codetypo

```sh
codetypo link remove @codetypo/dict-haskell
```
...
{
    // …
    "import": ["@codetypo/dict-haskell/codetypo-ext.json"],
    // …
}
```
