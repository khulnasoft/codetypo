...
```sh
npm install -g @codetypo/dict-software-terms
codetypo link add @codetypo/dict-software-terms
```

## Uninstall from codetypo

```sh
codetypo link remove @codetypo/dict-software-terms
```
...
{
    // …
    "import": ["@codetypo/dict-software-terms/codetypo-ext.json"],
    // …
}
```
