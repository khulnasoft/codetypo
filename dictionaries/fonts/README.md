...
```sh
npm install -g @codetypo/dict-fonts
codetypo link add @codetypo/dict-fonts
```

## Uninstall from codetypo

```sh
codetypo link remove @codetypo/dict-fonts
```
...
{
    // …
    "import": ["@codetypo/dict-fonts/codetypo-ext.json"],
    // …
}
```
