...
```sh
npm install -g @codetypo/dict-lorem-ipsum
codetypo link add @codetypo/dict-lorem-ipsum
```

## Uninstall from codetypo

```sh
codetypo link remove @codetypo/dict-lorem-ipsum
```
...
{
    // …
    "import": ["@codetypo/dict-lorem-ipsum/codetypo-ext.json"],
    // …
}
```
