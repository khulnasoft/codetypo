...
```sh
npm install -g @codetypo/dict-scala
codetypo link add @codetypo/dict-scala
```

## Uninstall from codetypo

```sh
codetypo link remove @codetypo/dict-scala
```
...
{
    // …
    "import": ["@codetypo/dict-scala/codetypo-ext.json"],
    // …
}
```
