...
export default class extends Generator {
    ...
    async prompting() {
        ...
        this.log(yosay('Welcome to the ' + chalk.red('codetypo-dicts') + ' generator!'));
        ...
        const props = await this.prompt([
            ...
            },
            {
                ...
                name: 'description',
                message: 'Description',
                default: (props) => title(props.friendlyName) + ' dictionary for codetypo.',
            },
            {
                type: 'input',
                name: 'srcFile',
        ...
        props.fullPackageName = '@codetypo/dict-' + props.packageName;
